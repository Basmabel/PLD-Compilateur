...
+
    switch(op){
        case Operation::ldconst:
            ...
            o<<"    movq	$"<<params[1]<<", -"<<varDest<<"(%rbp);"<<params[0]<<endl;;
            break;
        case Operation::add:
            varDest = bb->cfg->get_var_index(params[0]);
            var1 = bb->cfg->get_var_index(params[1]);
            var2 = bb->cfg->get_var_index(params[2]);
            o<<"    movq	-"<<var1<<"(%rbp), %rax ;"<<params[1]<<endl;
            o<<"    addl    -"<<var2<<"(%rbp), %rax ;"<<params[2]<<endl;
            o<<"    movq    %rax, -"<<varDest<<"(%rbp) ; "<<params[0]<<endl;
            break;
        case Operation::sub:
            varDest = bb->cfg->get_var_index(params[0]);
            var1 = bb->cfg->get_var_index(params[1]);
            var2 = bb->cfg->get_var_index(params[2]);
            o<<"    movq	-"<<var1<<"(%rbp), %rax;"<<params[1]<<endl;
            o<<"    subl    -"<<var2<<"(%rbp), %rax;"<<params[2]<<endl;
            o<<"    movq    %rax, -"<<varDest<<"(%rbp);"<<params[0]<<endl;
            break;
        case Operation::mul:
            varDest = bb->cfg->get_var_index(params[0]);
            ...
            var2 = bb->cfg->get_var_index(params[2]);
            o<<"    movq	-"<<var1<<"(%rbp), %rax;"<<params[1]<<endl;
            o<<"    imul    -"<<var2<<"(%rbp), %rax;"<<params[2]<<endl;
            o<<"    movq    %rax, -"<<varDest<<"(%rbp);"<<params[0]<<endl;
            break;
        case Operation::neg:
            varDest = bb->cfg->get_var_index(params[0]);
